// ModlistComparisonTool.Core - ActivityFeedLayout.cs
...
#region Layout parameters
	...
	public static readonly DependencyProperty RowSpacingProperty = DependencyProperty.Register("RowSpacing", typeof(double), typeof(ActivityFeedLayout), new PropertyMetadata(0d, OnPropertyChanged));

	/// <summary>
	///     Gets or sets the size of the whitespace gutter to include between items on the same row
	/// </summary>
	public double ColumnSpacing { get => _colSpacing; set => SetValue(ColumnSpacingProperty, value); }

	public static readonly DependencyProperty ColumnSpacingProperty = DependencyProperty.Register("ColumnSpacing", typeof(double), typeof(ActivityFeedLayout), new PropertyMetadata(0d, OnPropertyChanged));

	public Size MinItemSize { get => _minItemSize; set => SetValue(MinItemSizeProperty, value); }

	public static readonly DependencyProperty MinItemSizeProperty = DependencyProperty.Register("MinItemSize", typeof(Size), typeof(ActivityFeedLayout), new PropertyMetadata(Size.Empty, OnPropertyChanged));
...
#region Layout
	protected override Size MeasureOverride(VirtualizingLayoutContext context, Size availableSize)
	{
		...
		var firstRowIndex = Math.Max((int) (context.RealizationRect.Y / (MinItemSize.Height + RowSpacing)) - 1, 0);
		var lastRowIndex = Math.Min((int) (context.RealizationRect.Bottom / (MinItemSize.Height + RowSpacing)) + 1, context.ItemCount / 3);
		...
		var desiredItemWidth = Math.Max(MinItemSize.Width, (availableSize.Width - ColumnSpacing * 3) / 4);
