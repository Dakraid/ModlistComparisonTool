// ModlistComparisonTool.Core - DynamicResourceHelper.cs
...
#region Property
	public static readonly DependencyProperty PropertyProperty = DependencyProperty.RegisterAttached("Property", typeof(DependencyProperty), typeof(DynamicResourceHelper), new PropertyMetadata(OnPropertyChanged));
...
#region ResourceKey
	public static readonly DependencyProperty ResourceKeyProperty = DependencyProperty.RegisterAttached("ResourceKey", typeof(object), typeof(DynamicResourceHelper), new PropertyMetadata(OnResourceKeyChanged));
